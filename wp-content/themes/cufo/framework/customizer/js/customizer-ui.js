...
*/
	...
	function royalSlider( db, id, min, max, step, px, general ) {
		...
		var slider 	 = $( '#royal_sl_'+ db +'_'+ id ),
			...
			valuePX  = range.closest('div').find('.customize-control-title').find('strong'),
...
*/
	...
	var fakeRefresh = $( '#customize-control-royal_custom_css-refresh' ).find('select');
		fakeRefresh.hide();
	...
	function royalSubmitButton( id ) {
		...
		// submit field value
		$( '#customize-control-royal_' + id ).find('.royal-submit-btn').click(function() {
...
// Styles "disabled"
$('#customize-control-royal_theme_styles-select').find('option[value="default"]').prop('disabled', true);
...
// add active class to active color scheme
	var royalColorSchemes = $('#accordion-section-styles input:radio');

	// on load
	royalColorSchemes.filter(':checked').parent().addClass('royal-active-color-scheme');

	// on change
	royalColorSchemes.change(function() {
		royalColorSchemes.parent().removeClass('royal-active-color-scheme');

		if ( $(this).is(':checked') ) {
			$(this).parent().addClass('royal-active-color-scheme');
		}
	});

// color schemes
	$('#accordion-section-styles').click(function() {
		
		if ( ! $(this).hasClass('royal-render') ) {
			$(this).addClass('royal-render');


		    royalControlsWrap( 'theme_styles', 'scheme-style_1_cs', [
		        'style_1_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_2_cs', [
		        'style_2_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_3_cs', [
		        'style_3_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_4_cs', [
		        'style_4_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_5_cs', [
		        'style_5_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_6_cs', [
		        'style_6_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_7_cs', [
		        'style_7_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_8_cs', [
		        'style_8_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_9_cs', [
		        'style_9_cs'
		    ] );

		    royalControlsWrap( 'theme_styles', 'scheme-style_x_cs', [
		        'style_x_cs'
		    ] );

		    // theme styles color schemes
		    royalSelect( 'theme_styles', 'select', 'theme-style-select', [
		    	'scheme-style_1_cs',
		    	'scheme-style_2_cs',
		    	'scheme-style_3_cs',
		    	'scheme-style_4_cs',
...
$('#accordion-section-preloaders').click(function() {
...
$('#accordion-section-body').click(function() {
...
/* ----------------- Content Styling Options ----------------- */
	...
	var contentHelp = '\
		...
		<br>Page header, Blog &amp; Portfolio Posts containers, Posts Pagination block, Blog &amp; Portfolio Posts single contents, Similar Posts container, Contact page info and etc.\
	';
...
$('#accordion-section-sidebar').click(function() {
...
$('#accordion-section-logo').click(function() {
...
$('#accordion-section-menu').click(function() {
...
$('#accordion-section-page_header').click(function() {
	
	if ( ! $(this).hasClass('royal-render') ) {
		$(this).addClass('royal-render');


/* ----------------- Header Block General Options ----------------- */

	// blog header controls wrap
	royalControlsWrap( 'page_header', 'blog-header-wrap', [
		'blog_title',
		'blog_subtitle'
	] );

	// portfolio header controls wrap
	royalControlsWrap( 'page_header', 'portfolio-header-wrap', [
		'portfolio_title',
		'portfolio_subtitle'
	] );

	// contact header controls wrap
	royalControlsWrap( 'page_header', 'contact-header-wrap', [
		'contact_title',
		'contact_subtitle'
	] );
...
/* ----------------- Header Block Spacing Options ----------------- */
	...
	// padding controls wrap
	royalControlsWrap( 'page_header', 'padding-wrap', [
		'padding_gen',
		'padding_tp',
		'padding_rt',
		'padding_bt',
	...
	// padding sliders
	royalSlider( 'page_header', 'padding_gen', 0, 200, 1, 'px', true );
	royalSlider( 'page_header', 'padding_tp', 0, 200, 1, 'px', false );
	royalSlider( 'page_header', 'padding_rt', 0, 200, 1, 'px', false );
	royalSlider( 'page_header', 'padding_bt', 0, 200, 1, 'px', false );
	royalSlider( 'page_header', 'padding_lt', 0, 200, 1, 'px', false );
	royalAdvancedBTN( 'page_header', 'padding_ad', false );


/* ----------------- Header Block Styling Options ----------------- */

	// background color controls wrap
	royalControlsWrap( 'page_header', 'bg-color-wrap', [ 'bg_color', 'bg_color_tr' ] );

	// background gradient controls wrap
	royalControlsWrap( 'page_header', 'bg-gradient-wrap', [
		'bg_grad_angle',
		'bg_grad_col_1',
		'bg_grad_col_1_tr',
		'bg_grad_col_1_ps',
	...
	// background image controls wrap
	royalControlsWrap( 'page_header', 'bg-image-wrap', [
		'bg_img',
		'bg_img_sz',
		'bg_img_att'
	] );
	...
	// background color transparency slider
	royalSlider( 'page_header', 'bg_color_tr', 0, 1, 0.1, '', false );

	// background gradient sliders
	royalSlider( 'page_header', 'bg_grad_angle', 0, 360, 1,' deg', false );
	royalSlider( 'page_header', 'bg_grad_col_1_tr', 0, 1, 0.1, '', false );
	royalSlider( 'page_header', 'bg_grad_col_1_ps', 0, 100, 1, '%', false );
	royalSlider( 'page_header', 'bg_grad_col_2_tr', 0, 1, 0.1, '', false );
	royalSlider( 'page_header', 'bg_grad_col_2_ps', 0, 100, 1, '%', false );

	// background type select
	royalSelect( 'page_header', 'background', 'background-select', [ 'bg-color-wrap', 'bg-gradient-wrap', 'bg-image-wrap' ] );

	// border controls wrap
	royalControlsWrap( 
		'page_header', 'border-wrap',
		[
		'bd_size_gen',
		'bd_style_gen',
		'bd_col_gen',
	...
	// border controls on/off
	royalCustomLabel( 'page_header', 'border_label', '#customize-control-royal_page_header-border-wrap', true );

	// border size sliders
	royalSlider( 'page_header', 'bd_size_gen', 0, 30, 1, 'px', true );
	royalSlider( 'page_header', 'bd_size_tp', 0, 30, 1, 'px', false );
	royalSlider( 'page_header', 'bd_size_rt', 0, 30, 1, 'px', false );
	royalSlider( 'page_header', 'bd_size_bt', 0, 30, 1, 'px', false );
	royalSlider( 'page_header', 'bd_size_lt', 0, 30, 1, 'px', false );
	royalAdvancedBTN( 'page_header', 'bd_ad', true );

	// border type select general
	royalBorderStyleGeneral( 'page_header', 'bd_style_gen' );

	// border colorpicker general
	royalBorderColorGeneral( 'page_header', 'bd_col_gen' );

	// border radius controls wrap
	royalControlsWrap( 'page_header', 'radius-wrap', ['radius'] );

	// border radius controls on/off
	royalCustomLabel( 'page_header', 'radius_label', '#customize-control-royal_page_header-radius-wrap', true );

	// border radius slider
	royalSlider( 'page_header', 'radius', 0, 50, 1,'px', false );

	// shadow controls wrap
	royalControlsWrap( 'page_header', 'shadow-wrap', [
		'shad_h',
		'shad_v',
		'shad_bl',
		'shad_sp',
	...
	// shadow controls on/off
	royalCustomLabel( 'page_header', 'shadow_label', '#customize-control-royal_page_header-shadow-wrap', true );

	// shadow sliders
	royalSlider( 'page_header', 'shad_h', -50, 50, 1, 'px', false );
	royalSlider( 'page_header', 'shad_v', -50, 50, 1, 'px', false );
	royalSlider( 'page_header', 'shad_bl', 0, 50, 1, 'px', false );
	royalSlider( 'page_header', 'shad_sp', -50, 50, 1, 'px', false );
	royalSlider( 'page_header', 'shad_col_tr', 0, 1, 0.1, '', false );


	var pageHeaderHelp = '\
		If you want to disable <strong>Page Header</strong> on separate page, leave empty <strong>Title & Sub Title</strong> fields.\
		<br>For example: <strong>Blog Title</strong>  and <strong>Blog Sub Title</strong> fields to disable on <strong>Blog</strong> page.\
		<br><br>If you have multiple Portfolio pages, the same header will be displayed for each page.\
		<br><br>For each Page\'s <strong>Default Template</strong> you should fill <strong>Title & Sub Title</strong> metaboxes from admin panel, when you are creating new one.\
	';
	...
	// label
	setTimeout(function() {
		royalCustomLabel( 'page_header', 'label', '#control_tabs_page_header, #control_tabs_page_header_title, #control_tabs_page_header_sTitle', true );
	}, 100 );
...
/* ----------------- Title Spacing Options ----------------- */
	...
	// padding bottom slider
	royalSlider( 'page_header_title', 'padding_bt', 0, 50, 1,'px', false );

	// margin bottom slider
	royalSlider( 'page_header_title', 'margin_bt', 0, 50, 1,'px', false );


/* ----------------- Title Styling Options ----------------- */

	// border bottom controls wrap
	royalControlsWrap( 'page_header_title', 'border-wrap', [
		'bd_style_bt',
		'bd_col_bt',
		'bd_size_bt',
		'bd_full_width'
	...
	// border bottom controls on/off
	royalCustomLabel( 'page_header_title', 'border_label', '#customize-control-royal_page_header_title-border-wrap', true );

	// border bottom size slider
	royalSlider( 'page_header_title', 'bd_size_bt', 0, 20, 1, 'px', false );


/* ----------------- Title Font Options ----------------- */

	// font options controls wrap
	royalControlsWrap( 'page_header_title', 'fonts-wrap', [
		'font_family',
		'font_size',
		'line_height',
		'letter_space',
	...
	// font size slider
	royalSlider( 'page_header_title', 'font_size', 10, 150, 1, 'px', false );

	// line height slider
	royalSlider( 'page_header_title', 'line_height', 10, 150, 1, 'px', false );

	// letter spacing slider
	royalSlider( 'page_header_title', 'letter_space', -20, 20, 0.1, 'px', false );

	// font weight slider
	royalSlider( 'page_header_title', 'font_weight', 100, 900, 100, '', false );

	// text shadow controls wrap
	royalControlsWrap( 'page_header_title', 'txt-shadow-wrap', [
		'txt_shad_h',
		'txt_shad_v',
		'txt_shad_bl',
		'txt_shad_col'
	...
	// text shadow controls on/off
	royalCustomLabel( 'page_header_title', 'txt_shadow_label', '#customize-control-royal_page_header_title-txt-shadow-wrap', true );

	// text shadow sliders
	royalSlider( 'page_header_title', 'txt_shad_h', -10, 10, 1, 'px', false );
	royalSlider( 'page_header_title', 'txt_shad_v', -10, 10, 1, 'px', false );
	royalSlider( 'page_header_title', 'txt_shad_bl', 0, 10, 1, 'px', false );
	...
	// label
	royalCustomLabel( 'page_header_title', 'label', '', false );
...
/* ----------------- Sub Title Font Options ----------------- */
	...
	// font options controls wrap
	royalControlsWrap( 'page_header_sTitle', 'fonts-wrap', [
		'font_family',
		'font_size',
		'line_height',
		'letter_space',
	...
	// font size slider
	royalSlider( 'page_header_sTitle', 'font_size', 10, 150, 1, 'px', false );

	// line height slider
	royalSlider( 'page_header_sTitle', 'line_height', 10, 150, 1, 'px', false );

	// letter spacing slider
	royalSlider( 'page_header_sTitle', 'letter_space', -20, 20, 0.1, 'px', false );

	// font weight slider
	royalSlider( 'page_header_sTitle', 'font_weight', 100, 900, 100, '', false );

	// text shadow controls wrap
	royalControlsWrap( 'page_header_sTitle', 'txt-shadow-wrap', [
		'txt_shad_h',
		'txt_shad_v',
		'txt_shad_bl',
		'txt_shad_col'
	...
	// text shadow controls on/off
	royalCustomLabel( 'page_header_sTitle', 'txt_shadow_label', '#customize-control-royal_page_header_sTitle-txt-shadow-wrap', true );

	// text shadow sliders
	royalSlider( 'page_header_sTitle', 'txt_shad_h', -10, 10, 1, 'px', false );
	royalSlider( 'page_header_sTitle', 'txt_shad_v', -10, 10, 1, 'px', false );
	royalSlider( 'page_header_sTitle', 'txt_shad_bl', 0, 10, 1, 'px', false );


	// Header Sub Title tabs -------------------------------
	royalTabs( 
		'page_header_sTitle', 
		[
		 'align'
	...
	// label
	royalCustomLabel( 'page_header_sTitle', 'label', '', false );
...
$('#accordion-section-blog_page').click(function() {
...
$('#accordion-section-blog_single').click(function() {
...
$('#accordion-section-folio_page').click(function() {
...
$('#accordion-section-portfolio_single').click(function() {
...
/* ----------------- Navigation Spacing Options ----------------- */
	...
	// height slider
	royalSlider( 'pSingle_nav', 'height', 25, 100, 1, 'px', false );
...
$('#accordion-section-gallery').click(function() {
...
$('#accordion-section-similar_posts').click(function() {
...
$('#accordion-section-comments').click(function() {
...
$('#accordion-section-inputs').click(function() {
...
/* ----------------- Search Spacing Options ----------------- */
	...
	// padding sliders
	royalSlider( 'inputs_search', 'padding_gen', 0, 25, 1, 'px', true );
	royalSlider( 'inputs_search', 'padding_tp', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'padding_rt', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'padding_bt', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'padding_lt', 0, 25, 1, 'px', false );
	...
	// margin sliders
	royalSlider( 'inputs_search', 'margin_gen', 0, 25, 1, 'px', true );
	royalSlider( 'inputs_search', 'margin_tp', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'margin_rt', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'margin_bt', 0, 25, 1, 'px', false );
	royalSlider( 'inputs_search', 'margin_lt', 0, 25, 1, 'px', false );
...
$('#accordion-section-pagination').click(function() {
...
$('#accordion-section-contact_page').click(function() {
...
$('#accordion-section-copy_and_socials').click(function() {
...
$('#accordion-section-typography').click(function() {
...
/* ----------------- General Options ----------------- */
	...
	var globalHeadings = [
		...
		'#page_header_sTitle_font_family',
...
*/
	...
	function royalCustomCSS( db, id ) {
		...
		// full screen
		textareaWrap.find('.fa').click(function() {
		...
		$('#customize-footer-actions').click(function() {
...
$('#accordion-section-custom_css').click(function() {
...
*/
	...
	$('#accordion-section-favicon').click(function() {
		
		if ( ! $(this).hasClass('royal-render') ) {
			$(this).addClass('royal-render');


	    // size 32 controls wrap
	    royalControlsWrap( 'favicon', 'size-32', [
	        'size_32'
	    ] );

	    // size 76 controls wrap
	    royalControlsWrap( 'favicon', 'size-76', [
	        'size_76'
	    ] );

	    // size 120 controls wrap
	    royalControlsWrap( 'favicon', 'size-120', [
	        'size_120'
	    ] );

	    // size 152 controls wrap
	    royalControlsWrap( 'favicon', 'size-152', [
	        'size_152'
	    ] );
...
$('#accordion-section-sidebar_widgets').click(function() {
...
$('#accordion-section-footer_widgets').click(function() {
...
*/
	...
	$('#customize-control-royal_preloader-label').find('input').change(function(){
		setTimeout(function(){
			royalRefreshValue();
		}, 300);
	});

	$('#customize-control-royal_preloader-bg_trans').find('select').change(function(){
		setTimeout(function(){
			royalRefreshValue();
		}, 300);
	});

	$('#customize-control-royal_preloader-anim').find('select').change(function(){
		setTimeout(function(){
			royalRefreshValue();
		}, 300);
	});

	$('#customize-control-royal_preloader-anim_size').find('select').change(function(){
		setTimeout(function(){
			royalRefreshValue();
		}, 300);
	});

	$('#customize-control-royal_preloader-bg_color_tr').find('input').keyup(function(){
		setTimeout(function(){
			royalRefreshValue();
		}, 300);
	});
