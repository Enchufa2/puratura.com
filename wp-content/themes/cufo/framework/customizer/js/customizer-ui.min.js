...
*/
	...
	function royalSlider( db, id, min, max, step, px, general ) {
		...
		if ( general === true ) {
			...
			$('#customize-control-royal_'+ db +'-'+ id).find('input').change(function(){
				siblings.find('.rf-slider-wrap input').val( $(this).val() ).trigger('change');
...
*/
	...
	function royalLightCheckbox(db, id) {
		...
		$('#customize-control-royal_'+ full_id).find('input').change(function(){
			...
			if ( $(this).is(':checked') ) {
				db_input.val(db_input_val.replace(full_id +'[false]', full_id +'[true]')).trigger('change');
			} else {
				db_input.val(db_input_val.replace(full_id +'[true]', full_id +'[false]')).trigger('change');
			}
		});
	}
	...
	function royalLightSelect(db, id) {
		...
		$('#customize-control-royal_'+ full_id).find('select').change(function(){
			...
			db_input.val(db_input_val).trigger('change');
		});			
	}
